...
export async function GET(request: Request) {
  ...
  const backendError = requireSupabaseBackendData("Competitions");
...
export async function DELETE(request: Request) {
  ...
  const forbidden = getForbiddenCompetitionField(payload, "delete");
...
function validateCompetitionPayload(payload: Record<string, unknown>): { data: Competition; error?: never } | { data?: never; error: Response } {
  const forbidden = getForbiddenCompetitionField(payload, "write");
...
function getForbiddenCompetitionField(payload: Record<string, unknown>, mode: "write" | "delete") {
  const serverLabels: Record<string, string> = {
    clubId: "Competition club",
    club_id: "Competition club",
    createdAt: "Competition creation time",
    created_at: "Competition creation time",
    updatedAt: "Competition update time",
    updated_at: "Competition update time",
  };
