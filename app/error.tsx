  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[var(--background)] px-4 text-[var(--foreground)]">
      <div className="max-w-md text-center">
        <BrandLogo className="mx-auto size-12 rounded-xl border border-[var(--border)]" priority />
        <p className="mt-4 text-xs font-semibold uppercase tracking-[0.2em] text-[var(--accent)]">Grapply</p>
