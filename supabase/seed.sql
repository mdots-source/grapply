...
insert into public.role_definitions (role, label, description, permissions) values
  ('owner', 'Owner', 'Full control over club settings, manual billing contact, roles, integrations, and all academy operations.', array['manage_club', 'manage_roles', 'manage_billing', 'manage_integrations', 'manage_classes', 'manage_members']),
